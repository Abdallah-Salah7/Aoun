...
class _EditCampaignState extends State<EditCampaign> {
  ...
  void initState() {
    ...
    amountController = TextEditingController(
      text: widget.campaignEntity.requiredAmount.toString(),
    );
  ...
  Widget build(BuildContext context) {
    return BlocListener<CampaignCubit, CampaignState>(
      listener: (context, state) {
        ...
        if (state is CampaignDeletedSuccess || state is CampaignUpdatedSuccess)
                      ...
                      child: ClipRRect(
                        ...
                        child:
                            _image != null
                                ...
                                : Image.network(
                                  widget.campaignEntity.imageUrl,
                                  fit: BoxFit.cover,
                                  errorBuilder:
                                      (c, o, s) => _buildUploadPlaceholder(),
                                ),
                      ),
                    ),
                  ),
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: () async {
                        ...
                        await context.read<CampaignCubit>().updateCampaign(
                ...
                Row(
                  children: [
                    Expanded(
                      child: InkWell(
                        onTap: () {
                          context.read<CampaignCubit>().deleteCampaign(
                            widget.campaignEntity.id,
                          );
  ...
  Widget _buildUploadPlaceholder() => Column(
    ...
    children: [
      Image(image: AssetImage(ImageAssets.upload), height: 59, width: 59),
      Text(
        "اضغط لتحميل الصورة",
  ...
  Widget _buildField(
    ...
    children: [
      Padding(
        ...
        child: Text(
          title,
          style: GoogleFonts.manrope(fontWeight: FontWeight.w500, fontSize: 22),
        ),
      ),
      const SizedBox(height: 10),
      Container(
