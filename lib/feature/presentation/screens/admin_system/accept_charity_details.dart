...
class AcceptCharityDetails extends StatelessWidget {
  const AcceptCharityDetails({super.key});
        ...
        SizedBox(
          ...
          child: _ActionButton(
            ...
            onPressed: () {
              showDialog(
                context: context,
                builder: (_) => const StopCharityDialog(),
              );
            },
          ),
        ),
...
class StopCharityDialog extends StatelessWidget {
  const StopCharityDialog({super.key});
          ...
          child: Column(
            ...
            children: [
              ...
              const Directionality(
                ...
                child: Text(
                  """
هل أنت متأكد من إيقاف حساب جمعية غيث للتنمية المجتمعية ؟
