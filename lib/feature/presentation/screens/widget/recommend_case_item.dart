...
class RecommendCaseItem extends StatelessWidget {
  final RecommendCaseEntity recommendCaseEntity;

  const RecommendCaseItem({
    super.key,
    required this.recommendCaseEntity,
  });

  bool get isFileImage => recommendCaseEntity.imageUrl.startsWith('file://');
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: () {
        print("Pressed Case ID = ${recommendCaseEntity.id}");
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (_) => CaseDetailsScreen(
              caseId: recommendCaseEntity.id,
            ),
          ),
        );
      },
          ...
          child: Column(
            ...
            children: [
              Stack(
                children: [
                  ClipRRect(
                    ...
                    child: _buildImage(recommendCaseEntity.imageUrl),
                  ),

                  if (recommendCaseEntity.isUrgent || isCompleted)
                    Positioned(
                      top: 10,
                      right: 10,
                      child: Container(
              ...
              Padding(
                ...
                child: Text(
                  recommendCaseEntity.description,
                  style: GoogleFonts.manrope(
              ...
              Padding(
                ...
                child: ClipRRect(
                  ...
                  child: LinearProgressIndicator(
                    value: recommendCaseEntity.progress,
                    minHeight: 8,
              ...
              isCompleted
                ...
                child: Row(
                  children: [
                    Text(
                      "تم جمع ${recommendCaseEntity.collectedAmount} ج.م",
                      style: GoogleFonts.manrope(
                        fontSize: 16,
                        fontWeight: FontWeight.bold,
                        color: const Color(0xff255A41),
                    ...
                    const Spacer(),
                    Text(
                      "من ${recommendCaseEntity.requiredAmount}",
                      style: GoogleFonts.manrope(
                        fontSize: 15,
                        fontWeight: FontWeight.bold,
                        color: const Color(0xff757575),
