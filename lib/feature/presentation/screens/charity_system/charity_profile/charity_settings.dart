...
class CharitySettings extends StatefulWidget {
  const CharitySettings({super.key});

  @override
  State<CharitySettings> createState() => _CharitySettingsState();
}

class _CharitySettingsState extends State<CharitySettings> {
      ...
      child: Column(
        children: [
          ...
          _switchTile(
            ...
            value: dailyReports,
            onChanged: (value) => setState(() => dailyReports = value),
          ),
        ],
      ),
    );
