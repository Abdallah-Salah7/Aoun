...
import 'package:aoun/feature/presentation/screens/charity_system/chatbot/response_screen.dart';
  ...
  void initState() {
    ...
    Future.delayed(const Duration(seconds: 1), () {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (_) => ResponseScreen(question: widget.question),
        ),
      );
    });
  }
        ...
        body: SafeArea(
          child: Column(
            children: [
              ...
              MessageBubble(text: widget.question, isUser: true),
