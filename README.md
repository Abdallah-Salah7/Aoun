<p align="center">
  <img src="./docs/assets/logo.png" alt="Aoun logo" width="120">
</p>
...
**🔗 Live:** _Add your deployed API/admin-panel URL here once hosted (e.g. `https://aoun-api.databaseasp.net`, `https://aoun-admin.vercel.app`)._
